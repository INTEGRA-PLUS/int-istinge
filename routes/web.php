...
Route::get('onepay/crear-mes-actual','FacturasController@crearOnepayFacturasMesActual')->name('onepay.crear.mes.actual');
...
Route::group(['prefix' => 'empresa', 'middleware' => ['auth']], function () {
	...
	Route::group(['prefix' => 'reportes'], function () {
		...
		Route::get('/reporte/1/2', 'ReportesController@reporte_1_2_mostrar')->name('reportes.mintic.1.2');
	...
	Route::group(['prefix' => 'contratos'], function () {
		...
		Route::get('deshabilitados/exportar', 'ContratosController@exportar')->name('contratos.exportar');
...
Route::get('/clientes/create_crm/{id}', 'ContactosController@createCrm')->name('cliente.create_crm');
...
Route::get('/exportar-contratos/anio/trimestre', 'ReportesController@generarExcel')->name('exportar.reportes.contratos.excel');
