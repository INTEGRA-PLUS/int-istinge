...
<p>Medios de pago Nequi: 3206909290 Cuenta de ahorros Bancolombia 42081411021 CC 1001912928 Ximena Herrera representante legal. Adjunte su pago para reactivar su membresía</p>
    ...
    <?php if (isset($_SESSION['permisos']['738'])) { ?>
        <a href="{{route('tipos-gastos.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Nuevo Tipo de Gasto</a>
    <?php } ?>
    @endif
@endsection
...
@section('content')
	...
	<div class="row card-description">
		<div class="col-md-12">
			<table class="table table-striped table-hover w-100" id="table-gastos">
