...
<li class="nav-item" id="asistencias">
    <a class="nav-link" data-toggle="collapse" href="#ui-asistencias" aria-expanded="false" aria-controls="ui-asistencias">
        <i class="menu-icon fas fa-clock"></i>
        <span class="menu-title">Control de Asistencias</span>
        <i class="menu-arrow"></i>
    </a>
    <div class="collapse" id="ui-asistencias">
        <ul class="nav flex-column sub-menu">
            <li class="nav-item" id="asistencias-empleados">
                <a class="nav-link" href="{{route('asistencias.index')}}">Ingreso de empleados</a>
            </li>
            <li class="nav-item" id="asistencias-reportes">
                <a class="nav-link" href="{{route('asistencias.reportes')}}">Reportes</a>
            </li>
        </ul>
    </div>
</li>
