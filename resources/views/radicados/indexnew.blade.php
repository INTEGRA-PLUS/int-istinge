...
@section('boton')
    ...
    @else
        @if (isset($_SESSION['permisos']['5']))
            <a href="{{ route('contactos.create') }}" class="btn btn-outline-info btn-sm"><i class="fas fa-plus"></i> Nuevo
                Cliente</a>
        @endif
        @if (isset($_SESSION['permisos']['411']))
            <a href="{{ route('contratos.create') }}" class="btn btn-outline-info btn-sm"><i class="fas fa-plus"></i> Nuevo
                Contrato</a>
        @endif
        @if (isset($_SESSION['permisos']['202']))
            <a href="{{ route('radicados.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Nuevo
                Radicado</a>
        @endif
    @endif
@endsection
...
@section('content')
    ...
    <div class="row card-description">
        <div class="col-md-12">
            <ul class="nav nav-pills" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="sin_gestionar-tab" data-toggle="tab" href="#sin_gestionar" role="tab"
                        aria-controls="sin_gestionar" aria-selected="true">PENDIENTES</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="gestionados-tab" data-toggle="tab" href="#gestionados" role="tab"
                        aria-controls="gestionados" aria-selected="false">SOLVENTADOS</a>
                </li>
            </ul>
            <hr
            ...
            <div class="tab-content fact-table" id="myTabContent">
                <div class="tab-pane fade show active" id="sin_gestionar" role="tabpanel"
                    aria-labelledby="sin_gestionar-tab">
                    <div class="text-right">
                            ...
                            @else
                                <div class="btn-group dropdown">
                                    @if (isset($_SESSION['permisos']['750']))
                                        <a href="{{ route('campos.organizar', 12) }}" class="btn btn-warning mr-1"><i
                                                class="fas fa-table"></i> Organizar Tabla</a>
                                    @endif
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="javascript:void(0)" id="btn_solventar"><i
                                            ...
                                            Casos</a>
                                        <a class="dropdown-item" href="javascript:void(0)" id="btn_destroy"><i
                                                class="fas fa-times fa-fw" style="margin-left:4px; "></i> Eliminar Casos</a>
                                    </div>
                                </div>
                            @endif
                        @endif
                        ...
                        <div class="btn-group">
                            <a href="javascript:getDataTable()" class="btn btn-success btn-sm my-1"><i
                                    class="fas fa-sync"></i>Actualizar</a>
                                ...
                                <div class="card-body pb-3 pt-2" style="background: #f9f9f9;">
                                    <div class="row">
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Nro" id="codigo"
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Contrato" id="contrato"
                                                class="form-control rounded">
                                        </div>
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Cliente" class="form-control rounded selectpicker"
                                                id="cliente" data-size="5" data-live-search="true">
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Celular" id="telefono"
                                                class="form-control rounded">
                                        </div>
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Servicio" class="form-control rounded selectpicker"
                                                id="servicio" data-size="5" data-live-search="true">
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Estado" class="form-control rounded selectpicker"
                                                id="estatus">
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Creado" class="form-control rounded selectpicker"
                                                id="creado">
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Prioridad" class="form-control rounded selectpicker"
                                                id="prioridad">
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Técnico" class="form-control rounded selectpicker"
                                                id="tecnico" data-size="5" data-live-search="true">
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Creado por" class="form-control rounded selectpicker"
                                                id="responsable" data-size="5" data-live-search="true">
                                                @foreach ($responsables as $responsable)
                                                    <option value="{{ $responsable->id }}">{{ $responsable->nombres }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Fecha Fin" id="tiempo_fin"
                                                name="tiempo_fin" class="form-control rounded creacion"
                                                autocomplete="off">
                                        </div>
                                        <div class="col-md-3 pl-1 pt-1">
                                            <input type="text" placeholder="Direccion" id="direccion"
                                                name="direccion" class="form-control rounded" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 pl-1 pt-1 text-center">
                                            <a href="javascript:cerrarFiltrador()"
                                                class="btn btn-icons ml-1 btn-outline-danger rounded btn-sm p-1"
                                                title="Limpiar parámetros de busqueda"><i class="fas fa-times"></i></a>
                                            <a href="javascript:void(0)" id="filtrar"
                                                class="btn btn-icons btn-outline-info rounded btn-sm p-1"
                                                title="Iniciar busqueda avanzada"><i class="fas fa-search"></i></a>
                                            @if (isset($_SESSION['permisos']['831']))
                                                <a href="javascript:exportar('0');"
                                                    class="btn btn-icons mr-1 btn-outline-success rounded btn-sm p-1"
                                                    title="Exportar"><i class="fas fa-file-excel"></i></a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                        ...
                        @if (isset($_SESSION['permisos']['841']))
                            ...
                            @else
                                <div class="btn-group dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="javascript:void(0)" id="btn_reabrir"><i
                                                class="fas fa-check-double fa-fw" style="margin-left:4px; "></i> Reabrir
                                            Casos</a>
                                    </div>
                                </div>
                            @endif
                        @endif
                        <a href="javascript:getDataTableG()" class="btn btn-success btn-sm my-1"><i
                                class="fas fa-sync"></i>Actualizar</a>
                        <a href="javascript:abrirFiltradorG()" class="btn btn-info btn-sm my-1" id="boton-filtrarG"><i
                                class="fas fa-search"></i>Filtrar</a>
                    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="card shadow-sm border-0">
                                <div class="card-body pb-3 pt-2" style="background: #f9f9f9;">
                                    <div class="row">
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Nro" id="codigoG"
                                                class="form-control rounded">
                                        </div>
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Fecha" id="fechaG" name="fecha"
                                                class="form-control rounded creacion" autocomplete="off">
                                        </div>
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Contrato" id="contratoG"
                                                class="form-control rounded">
                                        </div>
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Cliente" class="form-control rounded selectpicker"
                                                id="clienteG" data-size="5" data-live-search="true">
                                                @foreach ($clientes as $cliente)
                                                    <option value="{{ $cliente->nit }}">{{ $cliente->nombre }}
                                                        {{ $cliente->apellido1 }} {{ $cliente->apellido2 }} -
                                                        {{ $cliente->nit }}</option>
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Celular" id="telefonoG"
                                                class="form-control rounded">
                                        </div>
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Servicio" class="form-control rounded selectpicker"
                                                id="servicioG" data-size="5" data-live-search="true">
                                                @foreach ($servicios as $servicio)
                                                    <option value="{{ $servicio->id }}">{{ $servicio->nombre }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Técnico" class="form-control rounded selectpicker"
                                                id="tecnicoG" data-size="5" data-live-search="true">
                                                @foreach ($tecnicos as $tecnico)
                                                    <option value="{{ $tecnico->id }}">{{ $tecnico->nombres }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <select title="Creado por" class="form-control rounded selectpicker"
                                                id="responsableG" data-size="5" data-live-search="true">
                                                @foreach ($responsables as $responsable)
                                                    <option value="{{ $responsable->id }}">{{ $responsable->nombres }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="col-md-2 pl-1 pt-1">
                                            <input type="text" placeholder="Fecha Fin" id="tiempo_finG"
                                                name="tiempo_finG" class="form-control rounded creacion"
                                                autocomplete="off">
                                        </div>
                                        <div class="col-md-3 pl-1 pt-1">
                                            <input type="text" placeholder="Direccion" id="direccionG"
                                                name="direccionG" class="form-control rounded" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 pl-1 pt-1 text-center">
                                            <a href="javascript:cerrarFiltradorG()"
                                                class="btn btn-icons ml-1 btn-outline-danger rounded btn-sm p-1"
                                                title="Limpiar parámetros de busqueda"><i class="fas fa-times"></i></a>
                                            <a href="javascript:void(0)" id="filtrarG"
                                                class="btn btn-icons btn-outline-info rounded btn-sm p-1"
                                                title="Iniciar busqueda avanzada"><i class="fas fa-search"></i></a>
                                            @if (isset($_SESSION['permisos']['831']))
    ...
    <div class="modal fade" id="tecnicoModal" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body px-0">
                    @include('radicados.modal.tecnico')
                </div>
            </div>
        </div>
    </div>
...
@section('scripts')
    <script>
        ...
        window.addEventListener('load', function() {
            ...
            $('#fechaG, #clienteG, #servicioG, #estatusG, #creadoG, #prioridadG, #tecnicoG, #responsableG, #tiempo_finG')
                .on('change', function() {
                    getDataTableG();
                    return false;
                });
            ...
            $('#btn_modal_tecnico').click(function() {
                modal_tecnico();
            });
            ...
            $('#fecha, #cliente, #servicio, #estatus, #creado, #prioridad, #tecnico, #responsable, #tiempo_fin').on(
                'change',
                function() {
                    getDataTable();
                    return false;
        ...
        function exportar(otp) {
            if (otp == 0) {
                window.location.href = window.location.pathname + '/exportar?codigo=' + $('#codigo').val() + '&fecha=' + $(
                        '#fecha').val() + '&contrato=' + $('#contrato').val() + '&cliente=' + $('#cliente').val() +
                    '&telefono=' + $('#telefono').val() + '&servicio=' + $('#servicio').val() + '&estatus=' + $('#estatus')
                    .val() + '&prioridad=' + $('#prioridad').val() + '&tecnico=' + $('#tecnico').val() + '&tiempo_fin=' + $(
                        '#tiempo_fin').val() + '&otp=' + otp;
            } else {
                window.location.href = window.location.pathname + '/exportar?codigo=' + $('#codigoG').val() + '&fecha=' + $(
                        '#fechaG').val() + '&contrato=' + $('#contratoG').val() + '&cliente=' + $('#clienteG').val() +
                    '&telefono=' + $('#telefonoG').val() + '&servicio=' + $('#servicioG').val() + '&estatus=' + $(
                        '#estatusG').val() + '&prioridad=' + $('#prioridadG').val() + '&tecnico=' + $('#tecnicoG').val() +
                    '&tiempo_fin=' + $('#tiempo_finG').val() + '&otp=' + otp;
            }
        }

        function tecnico_lote_store() {
            var radicados = [];
            let tecnico = $('#tecnico_lote').val();
            ...
            if (nro <= 0) {
                swal({
                    title: 'ERROR',
                    html: 'Para ejecutar esta acción, debe al menos seleccionar un radicado',
                    type: 'error',
                });
                return false;
            }
            ...
            if (nro > 25) {
                swal({
                    title: 'ERROR',
                    html: 'Sólo se permite ejecutar 25 radicados por lotes',
                    type: 'error',
                });
                return false;
            }
            ...
            swal({
                title: '¿Desea asignar el tecnico a ' + nro + ' radicados en lote?',
                ...
                if (result.value) {
                    ...
                    let url = `{{ route('radicados.asignaciontecnico') }}`
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            swal({
                                ...
                                html: 'Radicados asignados al tecnico correctamente.',
                                type: 'success',
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            swal({
                                title: 'PROCESO REALIZADO',
                                html: '<strong>' + data.correctos + ' radicados ' + state +
