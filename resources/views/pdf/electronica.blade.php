...
@endphp
    ...
    <div style="">
        <table border="0" class="titulo">
            ...
            <tr>
                ...
                <td colspan="">{{isset($factura->contract()->address_street) && $factura->contract()->address_street != "" ? $factura->contract()->address_street : $factura->cliente()->direccion }}</td>
            </tr>
            <tr>
    ...
    <div style="">
        <table border="0" class="titulo">
            <tr>
                <th width="23.5%" class="right smalltd">NRO FACTURA</th>
