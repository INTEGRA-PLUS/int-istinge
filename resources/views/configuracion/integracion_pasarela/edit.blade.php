...
@section('boton')
        {{-- Agregando nueva pasarela de pago topPay --}}

        @if($servicio->nombre == 'TOPPAY')
	    	...
	    	<div class="modal-dialog modal-dialog-centered" role="document">
	    		<div class="modal-content">
	    			...
	    			<div class="modal-body">
	    				<p class="text-justify">Para obtener las credenciales necesarias, sólo debes registrarte en el <a href="#" target="_blank" class="alert-link">Dashboard de Comercios</a>.</p>
    ...
    @endif
    {{-- Fin de la integracion pasarela de pago toppay --}}
