        	...
        	<div class="card shadow-sm border-0">
        		<div class="card-body py-3" style="background: #f9f9f9;">
        			<div class="row">
                        ...
                        <div class="col-md-3 pl-1 pt-1">
                            <select title="Tipo" class="form-control selectpicker" id="tipo" data-size="5">
                                <option value="">Todos</option>
                                <option value="creacion_ingresos">Creación de ingresos</option>
                                <option value="envio_siigo">Envio a siigo</option>
                                <option value="cambio_electronica">Cambio de estandar a electronica</option>
                            </select>
                        </div>
                        <div class="col-md-3 pl-1 pt-1">
                            <div class="row">
...
<script>
    ...
    function() {
        ...
        $('#client_id, #created_by, #tipo, #desde, #hasta').on('change',function() {
            getDataTable();
            return false;
        });
    });
