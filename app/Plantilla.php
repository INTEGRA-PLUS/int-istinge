...
class Plantilla extends Model
{
     ...
     */
    protected $fillable = [
        'id', 'nro', 'tipo', 'clasificacion', 'title', 'contenido', 'archivo', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at', 'body_text', 'lectura', 'empresa', 'language', 'body_dinamic', 'body_header'
    ];
