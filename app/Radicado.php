...
class Radicado extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['cliente','revision','fecha','medio','grado', 'nombre', 'telefono', 'correo', 'direccion', 'contrato', 'desconocido', 'estatus', 'codigo', 'empresa', 'firma', 'prioridad', 'barrio'];
