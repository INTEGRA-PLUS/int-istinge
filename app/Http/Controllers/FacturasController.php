  ...
  */
    public function edit($id){
        ...
        if ($factura) {
            ...
            return redirect('empresa/facturas-index')->with('success', 'La factura de venta '.$factura->codigo.' ya esta cerrada');
        }
        return redirect('empresa/facturas-index')->with('success', 'No existe un registro con ese id');
    }
  ...
  */
        ...
        try {
            ...
            if(isset($response->status) && $response->status == 'success'){
                ...
                if(request()->ajax()){
                    ...
                    return redirect('/empresa/facturas')->with('message_success', 'Factura emitida correctamente con el cufe: ' .$response->cufe);
                }
            }
   ...
   /**
    ...
    public function xmlFacturaVentaMasivo($id)
    {
        $FacturaVenta = Factura::find($id);
        if (!$FacturaVenta) {
            return redirect('/empresa/facturas-index')->with('error', "No se ha encontrado la factura de venta, comuniquese con soporte.");
        }
        ...
        if ($FacturaVenta) {
            ...
            if (!isset($res['statusCode']) && isset($res['message'])) {
                return redirect('/empresa/facturas-index')->with('message_denied', $res['message']);
            }
    ...
    public function log($id)
    {
        ...
        return redirect('empresa/facturas-index')->with('danger', 'LA FACTURA DE SERVICIOS NO HA ENCONTRADO');
    }
