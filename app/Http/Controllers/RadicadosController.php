...
class RadicadosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('radicados.indexnew', compact('clientes', 'tipo', 'servicios', 'tabla', 'tecnicos', 'responsables', 'tecnicos'));
    }
    ...
    public function eliminarAdjunto($id)
    {
        ...
        $valores = explode(',', $id);
        $radicado = Radicado::where('empresa', Auth::user()->empresa)->where('id', $valores[0])->first();
    ...
    public function exportar(Request $request)
    {
        ...
        foreach ($radicados as $radicado) {
            ...
            $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue($letras[20] . $i, $radicado->responsable() ? $radicado->responsable()->nombres : '');
            $i++;
        }
    ...
    public function asignacionTecnico(Request $request)
    {
